...
public class WageCalculatorApp {
    ...
    public static void main(String[] args) {
        ...
        while (monthlyWage <= 0) {
            ...
            if (monthlyWage <= 0) {JOptionPane.showMessageDialog(null, "Input a valid number, please");}
        }
        while (weeklyHours <= 0) {
            weeklyHours=Double.parseDouble (JOptionPane.showInputDialog (null, "How many hours a week do you work?"));
            if (weeklyHours <= 0) {JOptionPane.showMessageDialog(null, "Input a valid number, please");}
        }
